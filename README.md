...
/*
 *File: simpe C programming 
 *Authors: Moshe Matabologa and {}
 *Date: 14/11/2023
 *Description: This prohect will print out the Required per project
*/
...
Syscall
 By: Julien Barbier
 Weight: 10
 Project to be done in teams of 2 people (your team: Onkabetse Mogomotsi, Moshe Matabologa)
